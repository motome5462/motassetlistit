...
router.get("/export/:id", async (req, res) => {
  try {
    ...
    worksheet.getCell("D28").value = pr.supplier;
    worksheet.getCell("D29").value = pr.supplierdetail;
    worksheet.getCell("J29").value = Number(pr.discount);
    worksheet.getCell("M28").value = pr.term;
    worksheet.getCell("M29").value = pr.delivery;
    worksheet.getCell("L30").value = pr.validity;
    worksheet.getCell("L31").value = pr.transport;
    worksheet.getCell("M32").value = pr.ref;
